  ...
  return (
    <>
      ...
      <div className="section">
        <div
          className={`h-screen w-screen relative overflow-hidden animate__animated ${
            currentSlide === 1 ? "animate__fadeIn" : "animate__fadeOut"
          }`}
        >
          <picture
            className={`max-h-full block h-full w-full transition-transform duration-[3500ms] ${
          ...
          >
            ...
            <img
              ...
              alt={data.secondSlide.bgUrl.alt}
              className="h-full w-full portrait:h-auto object-contain"
            />
          </picture>
